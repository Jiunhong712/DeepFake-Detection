...
num_classes = 2
lenet5 = lenet5(input_shape, num_classes)
lenet5.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.000001), loss='categorical_crossentropy',
...
# Evaluate the model
test_loss, test_accuracy, test_auc = lenet5.evaluate(test_generator)
...
# Predict on test set
Y_pred = lenet5.predict(test_generator)
...
img_file = r'C:\Users\xavie\OneDrive\Documents\Y3S2\Y3S2 Machine Learning\Assignment\lenet5architecture.png'
plot_model(lenet5, show_shapes=True, show_layer_names=True, to_file=img_file)
